...
export const commands = {
  ...
  diff: {
    usage: 'wiki diff <path>',
    summary: 'Show what a revision changed: the page against the revision before it (latest by default)',
    options: {
    ...
    examples: ['wiki diff acme.about.foo', 'wiki diff acme.about.foo --commit 12', 'wiki diff acme.about.foo --revision <id> --json']
  },
  log: {
    usage: 'wiki log <path>',
